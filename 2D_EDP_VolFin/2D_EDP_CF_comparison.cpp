...
|             . . 4 . . . ]           |       |       ]
  ...
  */
  ...
  ofstream file;
  string name_file = "2D_finVolMet/2D_finVolMet_comparison_" + to_string(DMR) + ".txt";
...
// g++ 2D_EDP_CF_comparison.cpp -lm -o 2D_EDP_CF_comparison && ./2D_EDP_CF_comparison